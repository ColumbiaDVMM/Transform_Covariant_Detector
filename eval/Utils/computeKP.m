...
function Allrepeatability = computeKP(parameters)
    ...
    list_method = parameters.list_method;
    ...
    for idxComb = 1:size(combinations,1)
        ...
        res = evaluateKeyPointsCompWithDir_ratio(combinations{idxComb,1}, combinations{idxComb,2}, list_method, combinations{idxComb,3}, parameters);
