...
main(int argc, char *argv[]) {
    ...
    if(imgColor.col*imgColor.row>){
        resize(imgColor,imgColor,Size(0,0),maxsize/(double)imgColor.col*imgColor.row,maxsize/(double)imgColor.col*imgColor.row);
    }
	Mat imgGray;
